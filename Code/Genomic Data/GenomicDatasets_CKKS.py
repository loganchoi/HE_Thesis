...
def prostate_cancer_data():
    ...
    df1 = pd.read_csv("/Users/loganchoi/Desktop/HE_Thesis/Data/whole_dataset_prostate_cancer.csv")
    ...
    merged_df = (merged_df - merged_df.mean()) / merged_df.std().replace(0, 1)
...
def lung_cancer_data():
    print("Lung Cancer")
    df1 = pd.read_csv("/Users/loganchoi/Desktop/HE_Thesis/Data/whole_dataset_lung_cancer.csv")
...
x_train, y_train, x_test, y_test, column_names = prostate_cancer_data()
